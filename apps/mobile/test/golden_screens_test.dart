...
void main() {
  ...
  for (final route in <(String, String)>[
    ...
    ('/today', 'today'),
    ('/metrics', 'metrics'),
    ('/day-timeline', 'product_day_timeline'),
    ('/activity/suggestion', 'product_activity_suggestion'),
    ('/activity/sports', 'product_activity_sports'),
    ('/vitals/temperature', 'product_temperature_boundary'),
    ('/trends', 'trends'),
    ('/journal', 'journal'),
    ('/you', 'you'),
    ('/you/profile', 'product_profile'),
    ('/you/data', 'data_hub'),
