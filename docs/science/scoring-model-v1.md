# LibreRing scoring model V1

Status: approved for production implementation on 2026-08-24; not clinically
validated. Calculation version: `1.0.0`.
...
| Recovery sleep support | Sleep V1 | current result | direct contributor; 40% | missing allowed only if adequate pulse remains; confidence falls | last-night support, avoids reusing stages |
