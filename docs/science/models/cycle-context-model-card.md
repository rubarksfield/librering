...
- **input_provenance:** user-entered in R12 v0.1. R12 physiology is not used.
...
- **calibration:** none. No physiology-derived prediction ships in v0.1.
- **baseline_method:** none for R12 v0.1. Future phase-conditioned baselines need
