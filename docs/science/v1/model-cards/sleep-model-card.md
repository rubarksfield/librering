...
- **calibration:** none to outcomes. Curves are V1 research choices tested only
  on synthetic data.
...
- **contributor_formulas:** duration band/penalty; efficiency/interruption blend;
  ...
  are in `../../scoring-model-v1.md` and executable source.
...
- **known_limitations:** no R12 PSG validation; timezone/no-wear semantics pending;
  fixed V1 curves may not fit disability, shift work, older adults, adolescents,
...
- **change_history:** 2026-08-23 initial independent model; firmware stages given
  zero weight; 2026-08-24 approved unchanged for V1 implementation.
